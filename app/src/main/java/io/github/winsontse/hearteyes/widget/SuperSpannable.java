...
public class SuperSpannable extends SpannableStringBuilder {

    private int flag = Spannable.SPAN_EXCLUSIVE_EXCLUSIVE;

    public SuperSpannable() {
        super("");
    }

    public SuperSpannable(CharSequence text) {
        super(text);
    }

    public SuperSpannable(CharSequence text, Object... spans) {
        super(text);
    ...
    public SuperSpannable(CharSequence text, Object span) {
        super(text);
     ...
     * @return this {@code SuperSpannable}.
     */
    public SuperSpannable append(CharSequence text, Object... spans) {
        append(text);
        for (Object span : spans) {
    ...
    public SuperSpannable append(CharSequence text, Object span) {
        append(text);
        setSpan(span, length() - text.length(), length());
        return this;
    }
     ...
     * @return this {@code SuperSpannable}.
     */
    public SuperSpannable append(CharSequence text, ImageSpan imageSpan) {
        text = "." + text;
        append(text);
     ...
     */
    @Override
    public SuperSpannable append(CharSequence text) {
        super.append(text);
        return this;
    }
     ...
     */
    @Deprecated
    public SuperSpannable appendText(CharSequence text) {
        append(text);
        return this;
    }
     ...
     * @return {@code SuperSpannable}.
     */
    public SuperSpannable findAndSpan(CharSequence textToSpan, GetSpan getSpan) {
        int lastIndex = 0;
        while (lastIndex != -1) {
    ...
    /**
     * Sets span objects to the text. This is more efficient than creating a new instance of SuperSpannable
